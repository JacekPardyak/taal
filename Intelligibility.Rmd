...
```{r, echo=FALSE, eval=FALSE}
library(leaflet)
nycounties <- rgdal::readOGR("./ref-countries-2020-60m.geojson/CNTR_BN_60M_2020_3035_INLAND.geojson")
...
leaflet(nycounties) %>%
  ...
  addPolygons(stroke = FALSE, smoothFactor = 0.3, fillOpacity = 1,
    fillColor = ~pal(FID),
    label = ~paste0(FID, ": ", formatC(FID, big.mark = ","))) %>%
  addLegend(pal = pal, values = ~FID, opacity = 1.0,
